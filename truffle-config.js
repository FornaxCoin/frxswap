...
module.exports = {
  ...
  networks: {
    ...
    bsc: {
      provider: () =>
          new HDWallet(
              '0x1cd194d2a436dab859b7d62452f8decc6705259cdb56d399f99f99e11ef356a4',
    ...
    rinkeby: {
      provider: () => new HDWallet("6343d2e0502e5133cb74c528189598264456fdd079c72cbaa78d3605defc3801", `https://rinkeby.infura.io/v3/b20934f8d48849539969d4a6a28a3831`),
      network_id: 4,       // Ropsten's id
      gas: 5500000,        // Ropsten has a lower block limit than mainnet
      confirmations: 2,    // # of confs to wait between deployments. (default: 0)
      timeoutBlocks: 15000,  // # of blocks before a deployment times out  (minimum/default: 50)
      skipDryRun: true     // Skip dry run before migrations? (default: false for public nets )
    },
